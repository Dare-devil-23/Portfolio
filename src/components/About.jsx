      ...
      >
        {Projects &&
          Projects.map((n) => (
              <motion.div
                key={n.id}
                className="border border-zinc-800 rounded-md p-2 min-h-[320px] min-w-[325px] md:max-w-[325px] hover:border-zinc-600 duration-100 ease-in-out"
              >
